<title>Hal. Input Anggota</title>
<div id="label-page"><h3>Input Data Anggota</h3></div>
<div id="content">
	<form action="anggota-input-proses.php" method="post" enctype="multipart/form-data">
	<link rel="stylesheet" href="style.css">

		<table id="tabel-input">
			<tr>
				<td class="label-formulir">FOTO</td>
				<td class="isian-formulir"><input type="file" name="foto" class="isian-formuli isianr-formulir-border"></td>
			</tr>
			<tr>
